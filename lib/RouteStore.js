...
var RouteStore = createStore({
    ...
    _handleNavigateSuccess: function (route) {
        var currTransactionId = route && route.get('navigate') && route.get('navigate').transactionId;

        if (this._isNavigateComplete ||
            (this._currentNavigate && currTransactionId && currTransactionId !== this._currentNavigate.transactionId)) {
            return;
        }
    ...
    _handleNavigateFailure: function (error) {
        var currNavigate = error && error.navigate;
        var currTransactionId = error && (error.transactionId || (currNavigate && currNavigate.transactionId));
